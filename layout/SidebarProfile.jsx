...
const SidebarProfile = () => {
    return (
        <div
            ...
            <div className="p-3 max-xl:mb-3 overflow-hidden eliseu__sidebar bg-white dark:bg-nightBlack rounded-2xl">
                ...
                <div
                    className="pt-6 mx-4 border-t lg:mx-6 user-meta-info md:mx-7 my-7 border-platinum dark:border-metalBlack">
                ...
                <svg className="absolute w-0 h-0">
                    ...
                    >
                        <path
                            d="M0.001,0.031 C0.001,0.014,0.026,0.001,0.055,0.001 H0.492 C0.506,0.001,0.52,0.004,0.53,0.009 L0.61,0.052 C0.62,0.057,0.634,0.06,0.649,0.06 H0.947 C0.977,0.06,1,0.074,1,0.091 V0.971 C1,0.987,0.977,1,0.947,1 H0.055 C0.026,1,0.001,0.987,0.001,0.971 V0.031"></path>
                    </clipPath>
                </svg>
            </div>
        </div>
