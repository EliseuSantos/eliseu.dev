...
const RightNav = ({midContainer}) => {
    const activeMenuItem = useMenuActive(midContainer, ".eliseu__nav__items li a");
    const pathname = usePathname();

    return (
        <div
            className="eliseu__nav__wrapper bg-snowWhite dark:bg-power__black max-xl:hidden fixed top-1/2 -translate-y-1/2 right-4 2xl:right-14 z-999 flex items-center flex-col gap-4 border border-platinum dark:border-metalBlack rounded-4xl px-2.5 py-4">
            {/* <!-- Site Logo Start --> */}
            ...
            <div className="my-4 menu">
                <ul className="space-y-2 text-center eliseu__nav__items">
            ...
            <div className="relative share group">
                ...
                <div
                    className="absolute bottom-0 flex items-center invisible px-5 py-6 space-x-3 transition-all duration-300 -translate-y-1/2 opacity-0 social-icons top-1/2 bg-white dark:bg-nightBlack rounded-4xl right-6 group-hover:opacity-100 group-hover:visible group-hover:right-10 -z-1">
